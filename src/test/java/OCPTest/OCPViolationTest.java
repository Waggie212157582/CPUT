...
public class OCPViolationTest {
    ...
    private final Staffmember staff = new Staffmember("Boniface","Kabaso","8702154869853","0781157896");
    private final Student stud = new Student("Muneem","Waggie","9101295335084","0738899666");
